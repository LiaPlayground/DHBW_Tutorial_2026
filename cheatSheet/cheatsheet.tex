...
%  Workshop "Interaktive OER mit LiaScript erstellen", DHBW 2026
...
% Tasten-Darstellung für den Shortcut-Block (CodeMirror / LiveEditor)
\newcommand{\kbd}[1]{%
  \tikz[baseline=(k.base)]{\node[draw=rulegray, line width=0.4pt,
    rounded corners=2pt, fill=codebg, inner sep=2pt, font=\ttfamily\scriptsize]
    (k) {#1};}}
...
\faGithub~Quellcode: \textbf{github.com/LiaPlayground/DHBW\_Tutorial\_2026}}
...
% --- Untere Zeile: Shortcuts (links) + Templates (rechts) ----------
%  Zwei halbbreite Boxen nebeneinander: je die wichtigere Hälfte.
%  CodeMirror-Kürzel des LiveEditors. macOS: Strg -> Cmd.
\noindent
\begin{minipage}[t]{0.495\linewidth}
\begin{tcolorbox}[infobase, colframe=mdblue!75, colbacktitle=mdblue,
  equal height group=editzeile,
  title={\faKeyboard~~Editor-Profitricks im LiveEditor \textnormal{\scriptsize(CodeMirror; Mac: \kbd{Strg}$\to$\kbd{Cmd})}}]
\scriptsize
\begin{minipage}[t]{0.48\linewidth}
\textbf{\color{mdblue}Multicursor \& Zeilen}\\[1pt]
\kbd{Strg}+\kbd{Klick} — weiterer Cursor\\[1pt]
\kbd{Strg}+\kbd{D} — nächstes gleiches Wort\\[1pt]
\kbd{Alt}+\kbd{$\uparrow$}/\kbd{$\downarrow$} — Zeile verschieben\\[1pt]
\kbd{Shift}+\kbd{Alt}+\kbd{$\uparrow$}/\kbd{$\downarrow$} — duplizieren
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}
\textbf{\color{mdblue}Bearbeiten \& Basics}\\[1pt]
\kbd{Strg}+\kbd{/} — aus-/einkommentieren\\[1pt]
\kbd{Strg}+\kbd{Shift}+\kbd{K} — Zeile löschen\\[1pt]
\kbd{Strg}+\kbd{F} — suchen\,/\,ersetzen\\[1pt]
\kbd{Strg}+\kbd{S} — speichern\,$\to$\,Vorschau
\end{minipage}
\end{tcolorbox}
\end{minipage}\hfill
\begin{minipage}[t]{0.495\linewidth}
\begin{tcolorbox}[infobase, colframe=liagreen!75, colbacktitle=liagreen,
  equal height group=editzeile,
  title={\faPuzzlePiece~~LiaScript-Templates \textnormal{\scriptsize(per \texttt{import:} im Header; alle: \texttt{github.com/LiaTemplates})}}]
\scriptsize
\begin{minipage}[t]{0.48\linewidth}
\textbf{\color{liagreen}\faTerminal~~Code \& Daten}\\[1pt]
...
$\bullet$~\href{https://github.com/LiaTemplates/SQLite}{\texttt{SQLite}}~–~SQL\\
$\bullet$~\href{https://github.com/LiaTemplates/citations}{\texttt{citations}}~–~BibTeX\\
...
$\bullet$~\href{https://github.com/LiaTemplates/mermaid_template}{\texttt{mermaid}}~–~Diagramme\\
$\bullet$~\href{https://github.com/LiaTemplates/JSXGraph}{\texttt{JSXGraph}}~–~Mathematik\\
$\bullet$~\href{https://github.com/LiaTemplates/Vega}{\texttt{Vega}}~–~Daten-Charts\\
$\bullet$~\href{https://github.com/LiaTemplates/ABCjs}{\texttt{ABCjs}}~–~Musiknotation\\
$\bullet$~\href{https://github.com/LiaTemplates/Wikimedia}{\texttt{Wikimedia}}~–~Commons\\
$\bullet$~\href{https://github.com/LiaTemplates/Index}{\texttt{LiaTemplates/Index}}
\end{minipage}
\end{tcolorbox}
\end{minipage}
...
CC-BY-SA 4.0 — Sebastian Zug, DHBW 2026}
